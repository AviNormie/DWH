...
export default function NewPopularProduct() {
  ...
  useEffect(() => {
    ...
    // Filter popular products from sweets data
    const popularProducts = sweetsData
    ...
    const popularNamkeens = namkeenData
      .filter((n) => n.type === "popular")
      .map((n) => ({
        ...n,

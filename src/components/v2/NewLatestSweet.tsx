...
export default function NewLatestSweet() {
  ...
  const latestItems = useMemo(() => {
    return sweetsData.filter(p => p.type === "latest").slice(0, 3);
  }, []);
    ...
    return (
      <div className="flex justify-center items-center py-16">
        <div className="text-center">
          ...
          <p className="text-orange-600 font-medium">Loading sweets...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="py-12 bg-gradient-to-br from-orange-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="p-6 bg-gradient-to-br from-white to-orange-50/30">
                            ...
                            <div className="absolute top-full left-0 right-0 mt-2 bg-white border-2 border-orange-200 rounded-xl shadow-2xl max-h-60 overflow-y-auto z-50">
                              {item.pricing.map((pricing: Pricing, index: number) => (
                                <button
                                  ...
                                  className={`w-full flex items-center justify-between p-4 hover:bg-orange-50 transition-colors border-b border-orange-100 last:border-b-0 ${selected?.quantity === pricing.quantity &&
                    ...
                    <div className="flex justify-center">
                      <button
                        type="button"
                        className={`w-full max-w-xs py-4 px-6 rounded-xl font-semibold transition-all duration-300 shadow-lg ${(!hasPricingOptions || selected)
        ...
        {sweetsData.filter((p: { type: string }) => p.type === "latest").length > 3 && (
